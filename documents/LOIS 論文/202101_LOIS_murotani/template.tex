...
\bibitem{6} 齋藤,美絵子 “災害リスクコミュニケーションのためデジタルツールの効果に関する研究” 2018.03.23
\bibitem{7} 内閣府 “新型コロナウイルス感染症を踏まえた災害対応のポイント【第１版】について”
\bibitem{8} 毎日新聞 “避難所「先着順で満員、2回も振られる」台風10号、コロナ対策で収容人数の減少で” 2020.09.07
\bibitem{9} 株式会社バカン “株式会社バカンと宮崎県日南市、災害発生時にIoTを活用して避難所の混雑情報配信を支援する協定を締結” 2020.08.03
\bibitem{10} Spring “Why Spring?” https://spring.io/why-spring
\end{thebibliography}
